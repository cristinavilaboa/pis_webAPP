...
<!-- ************************** HEADER ***************************************-->
	...
	<!-- ************************** FIN HEADER ***************************************-->
		...
		<div id="wb_Text1" style="position:absolute;left:48px;top:240px;width:705px;height:42px;z-index:11;text-align:left;">
			...
			<h4 id=asunto style="text-align: left; color:#FFFFFF;font-family:'Trebuchet MS';">   </h4>
				<p id=remitente style="text-align: left; color:#FFFFFF;font-family:'Trebuchet MS';">  </p>
				<hr>
				<p id=contenido style="text-align: left; color:#FFFFFF;font-family:'Trebuchet MS';"> </p>
				<hr>
				<br>
    			<div>
